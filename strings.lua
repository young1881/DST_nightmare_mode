...
STRINGS.NAMES.SHADOWEYETURRET = "残缺-远古哨兵"
STRINGS.NAMES.SHADOWEYETURRET2 = "完整-远古哨兵 "
STRINGS.NAMES.WORMWOOD_SEEDS = "野性种子"

STRINGS.RECIPE_DESC.wormwood_moon_cap_recipe = "消耗50点饱食度，从体内结出月亮蘑菇（moon_cap）。"
STRINGS.CHARACTERS.GENERIC.ACTIONFAIL.BUILD.WORMWOOD_MOON_CAP_HUNGER = "我太饿了，没法这样做。"
STRINGS.CHARACTERS.WORMWOOD.ACTIONFAIL.BUILD.WORMWOOD_MOON_CAP_HUNGER = "朋友需要更多食物才能长出来……"
...
STRINGS.NAMES.LUNAR_TORCH = "月光火炬"
STRINGS.ACTIONS.TOSS_SCIENCE = "科学の投掷"
...
STRINGS.RECIPE_DESC.WX78MODULE_TASER = "扫描远古蜈蚣壳解锁"
STRINGS.RECIPE_DESC.WX78MODULE_NIGHTVISION = "扫描鼹鼠、洞穴蠕虫解锁"
STRINGS.RECIPE_DESC.WX78MODULE_LIGHT = "扫描鱿鱼、球状光虫解锁"

STRINGS.NAMES.KING_SQUID = "梦魇鱿王"
STRINGS.CHARACTERS.GENERIC.DESCRIBE.KING_SQUID = "比普通鱿鱼更让人不安。"
...
STRINGS.NAMES.DREADSWORD_REVIVAL = "注能-绝望石剑"
STRINGS.NAMES.DREADSWORD_PARRY = "招架-君王之剑"
STRINGS.NAMES.DREADSWORD_SWORDMASTER = "剑圣-君王之剑"
STRINGS.NAMES.DREADSWORD_TRACKING = "追踪之刃-君王之剑"
STRINGS.NAMES.DREADSWORD_BULWARK = "筑墙-君王之剑"
STRINGS.NAMES.DREADSWORD_DEATHSONG = "死歌-君王之剑"
STRINGS.NAMES.DREADSWORD_SMITH = "铸剑者-君王之剑"

STRINGS.CHARACTERS.GENERIC.DESCRIBE.DREADSWORD_REVIVAL = "勇者的证明为它注入了格挡之力。给予纯粹恐惧可修复耐久。"
STRINGS.CHARACTERS.GENERIC.DESCRIBE.DREADSWORD_PARRY = "彩红宝石将它铸成了招架-君王之剑。精准格挡，以守为攻。给予纯粹恐惧可修复耐久。"
STRINGS.CHARACTERS.GENERIC.DESCRIBE.DREADSWORD_SWORDMASTER = "彩红宝石将它铸成了剑圣-君王之剑。剑势凌厉，偶发一击可成双倍伤害。给予纯粹恐惧可修复耐久。"
STRINGS.CHARACTERS.GENERIC.DESCRIBE.DREADSWORD_TRACKING = "彩红宝石将它铸成了追踪之刃-君王之剑。挥砍所至，周遭敌影皆受其锋。给予纯粹恐惧可修复耐久。"
STRINGS.CHARACTERS.GENERIC.DESCRIBE.DREADSWORD_BULWARK = "彩红宝石将它铸成了筑墙-君王之剑。持握如盾，身若坚墙。给予纯粹恐惧可修复耐久。"
STRINGS.CHARACTERS.GENERIC.DESCRIBE.DREADSWORD_DEATHSONG = "彩红宝石将它铸成了死歌-君王之剑。以命换刃，每一击都在低吟。给予纯粹恐惧可修复耐久。"
STRINGS.CHARACTERS.GENERIC.DESCRIBE.DREADSWORD_SMITH = "彩红宝石将它铸成了铸剑者-君王之剑。剑身浸染位面之力。给予纯粹恐惧可修复耐久。"
STRINGS.CHARACTERS.WAXWELL.DESCRIBE.DREADSWORD_REVIVAL = "绝望与勇气，铸于同一刃上。"
