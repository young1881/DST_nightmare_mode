        ...
        timeline =
        {
            TimeEvent(4 * FRAMES, function(inst)
                inst.SoundEmitter:PlaySound(
                    "dontstarve_DLC003/creatures/elderdrake/clap")
            end),
    ...
    State {
        ...
        timeline =
        {
            TimeEvent(3 * FRAMES, function(inst)
                inst.SoundEmitter:PlaySound(
                    "dontstarve_DLC003/creatures/elderdrake/hit")
            end),
        },
...
CommonStates.AddSleepStates(states,
    {
        ...
        {
            TimeEvent(35 * FRAMES,
                function(inst) inst.SoundEmitter:PlaySound("ddontstarve_DLC003/creatures/elderdrake/sleep") end),
        },
    })
