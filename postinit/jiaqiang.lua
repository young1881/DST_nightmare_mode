...
TUNING.ALTERGUARDIAN_PHASE3_LASERDAMAGE = 400        --激光攻击力
...
TUNING.ALTERGUARDIAN_PHASE3_SUMMONRSQ = 500          --蓝圈大小，20为1格
TUNING.ALTERGUARDIAN_PHASE3_MAX_STUN_LOCKS = 1       --天体可僵直次数
