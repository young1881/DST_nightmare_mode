...
if true then
    AddRoom("Metal_Labyrinth", { -- Not a real Labyrinth.. more of a maze really.    铁迷宫
        ...
        contents = {
            ...
            distributeprefabs = {
                ...
                nightmarelight = 0.4,
                shadowdragon_spawner = 0.55,
                king_squid_spawner = 0.4,
                scanner_spawn = 0.2, 
                bishop_nightmare_spawner = 2.0,
                bishop_spawner = 2.0,
                knight_nightmare_spawner = 2.4,

                thulecite_pieces = 0.2,

                shadoweyeturret_spawner = 0.55,

                shadoweyeturret2_spawner = 0.3
            },
        }
    })
    ...
    AddTask("MeTal_Labyrinth_Task", {
        ...
        room_choices = {
            ["Metal_Labyrinth"] = function()
                return math.floor((3 + math.random(1)) * 1.2 + 0.5)
            end,
            ["HulkGuarden"] = 1,
        },
    ...
    AddRoom("BGMilitaryRoom", { --军事野地（存疑）
        ...
        contents = {
            ...
            distributeprefabs =
            {
                ...
                shadowdragon_spawner = 0.06,

                rook_nightmare_spawner = 0.09,
                knight_nightmare_spawner = 0.2,
                bishop_nightmare_spawner = 0.2,
                bishop_spawner = 0.2,
    ...
    -- 仅缩小中庭房间数（不能删任务，atrium_gate 依赖它）
    ...
    AddTaskPreInit("Sacred", function(task)
        ...
        task.room_choices = {
            ["SacredBarracks"] = function() return math.random(2, 3) end,
            ["Bishops"] = function() return math.random(2, 3) end,
            ["Spiral"] = 1,
            ["BrokenAltar"] = function() return math.random(2, 3) end,
            ["Altar"] = 1,
        }
    ...
    AddRoomPreInit("BGSacred", function(room) --家具野地
        room.contents.distributepercent = 0.18
        ...
        room.contents.distributeprefabs =
        {
            ...
            ruins_statue_head_spawner = .6,

            shadowdragon_spawner = .4,
            king_squid_spawner = 0.35,

            rook_nightmare_spawner = .7,

            ruins_statue_mage_spawner = .1,

            knight_nightmare_spawner = .99,

            bishop_nightmare_spawner = .99,
            bishop_spawner = .99,

            scanner_spawn = .09,

            shadoweyeturret_spawner = 0.3,
            shadoweyeturret2_spawner = 0.2
        }
    end)
    ...
    -- 军事兵营：随机位置刷新 1 座残缺远古伪科学站（避开中心侦察者/哨兵）
    local barracks_broken_altar_spots = {
        { x = -4, y = 0 },
        { x = 4, y = 0 },
        { x = 0, y = 3 },
        { x = 0, y = -3 },
    ...
    Layouts["Barracks"].layout["ancient_altar_broken_spawner"] = {
        barracks_broken_altar_spots[math.random(#barracks_broken_altar_spots)],
    }
