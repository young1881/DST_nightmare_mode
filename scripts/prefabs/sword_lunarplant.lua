    ...
    if inst._owner ~= owner then
        ...
        if owner ~= nil then
            inst._onownerequip = function(owner, data)
                if data ~= nil then
                    if data.item ~= nil and (data.item.prefab == "lunarplanthat" or data.item.prefab == "alterguardianhat") then
            ...
            if hat ~= nil and (hat.prefab == "lunarplanthat" or hat.prefab == "alterguardianhat") then
                SetBuffEnabled(inst, true)
            end
        end
    end
