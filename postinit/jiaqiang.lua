--1阶段
TUNING.ALTERGUARDIAN_PHASE1_HEALTH = 70000       --血量
...
--2阶段
TUNING.ALTERGUARDIAN_PHASE2_STARTHEALTH = 90000 --血量
...
--3阶段
TUNING.ALTERGUARDIAN_PHASE3_STARTHEALTH = 120000    --血量
TUNING.ALTERGUARDIAN_PHASE3_ATTACK_PERIOD = 2.65     --攻击间隔
TUNING.ALTERGUARDIAN_PHASE3_TRAP_CD = 25            --陷阱CD
TUNING.ALTERGUARDIAN_PHASE3_SUMMONCOOLDOWN = 30     --召唤CD
TUNING.ALTERGUARDIAN_PHASE3_DAMAGE = 340            --攻击力
TUNING.ALTERGUARDIAN_PHASE3_LASERDAMAGE = 520       --激光攻击力
TUNING.ALTERGUARDIAN_PHASE3_TRAP_LANDEDDAMAGE = 80 --陷阱攻击力
TUNING.ALTERGUARDIAN_PHASE3_TARGET_DIST = 58        --仇恨范围
TUNING.ALTERGUARDIAN_PHASE3_ATTACK_RANGE = 58       --攻击范围
TUNING.ALTERGUARDIAN_PHASE3_WALK_SPEED = 18.5        --移速
TUNING.ALTERGUARDIAN_PHASE3_RUNAWAY_BLOCK_TIME = 0.1     --可以阻挡天体移动的时间
TUNING.ALTERGUARDIAN_PHASE3_SUMMONMAXLOOPS = 100               --天体大虚影总数
TUNING.ALTERGUARDIAN_PHASE3_SUMMONRSQ = 1100                     --蓝圈大小，20为1格
TUNING.ALTERGUARDIAN_PHASE3_MAX_STUN_LOCKS = 0.1           --天体可僵直次数
...
--只因
TUNING.STALKER_ATRIUM_HEALTH = 80000        --血量
TUNING.STALKER_ATRIUM_PHASE2_HEALTH = 60000 --二阶段
