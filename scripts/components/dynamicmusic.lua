...
return Class(function(self, inst)
    ...
    local function StartCarnivalMusic(player, is_game_active)
        ...
        StartBusyTheme(player, theme,
            theme == BUSYTHEMES.CARNIVAL_MINIGAME and "summerevent/music/2" or "summerevent/music/1", 2)
    end
    ...
    local function StartTriggeredDanger(player, data)
        ...
        elseif _isenabled then
            ...
            local music = data ~= nil and TRIGGERED_DANGER_MUSIC[data.name or "default"] or
                TRIGGERED_DANGER_MUSIC.default
