local MakeLighterFire = require("prefabs/lunar_torchfire_common")
...
local COLOUR_ENVELOPE_NAME_SMOKE = "lunarfiresmokecolourenvelope"
local SCALE_ENVELOPE_NAME_SMOKE = "lunarfiresmokescaleenvelope"
local COLOUR_ENVELOPE_NAME = "lunarfirecolourenvelope"
local SCALE_ENVELOPE_NAME = "lunarfirescaleenvelope"
...
--64 / 255, 64 / 255, 208 / 255

local function InitEnvelope()
    EnvelopeManager:AddColourEnvelope(
        COLOUR_ENVELOPE_NAME_SMOKE,
        {
            { 0,    IntColour(64, 64, 208, 0) },
            { .3,   IntColour(64, 64, 208, 100) },
            { .55,  IntColour(59, 59, 205, 28) },
            { 1,    IntColour(59, 59, 205, 0) },
        }
    )
    ...
    EnvelopeManager:AddColourEnvelope(
        ...
        {
            { 0,    IntColour(64, 64, 208, 128) },
            { .49,  IntColour(64, 64, 208, 128) },
            { .5,   IntColour(64, 64, 225, 128) },
            { .51,  IntColour(32, 32, 225, 128) },
            { .75,  IntColour(32, 32, 225, 128) },
            { 1,    IntColour(16, 16, 225, 0) },
        }
    )
    ...
    EnvelopeManager:AddVector2Envelope(
        SCALE_ENVELOPE_NAME,
        {
            { 0,    { max_scale * 1.5, max_scale * 2.5 } }, ---- 调整火焰大小
            { 1,    { max_scale * 2 * 2, max_scale * 4 } },
        }
    )
...
return MakeLighterFire("lunar_torchfire", assets, nil, common_postinit, master_postinit)
